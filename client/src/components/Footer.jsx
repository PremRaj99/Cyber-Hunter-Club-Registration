...
const Footer = () => {
  return (
    <footer className="flex flex-col relative z-10 h-auto w-full">
      <div className="flex flex-col lg:flex-row justify-evenly bg-[#00D8FF] shadow-md box-border w-full text-left md:px-20">
